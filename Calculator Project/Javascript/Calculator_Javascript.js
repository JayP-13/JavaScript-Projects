//Creates an obhect to keep track of values
const Calculator = {
...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        //Wer are saying that if the Display_Value does not contain a decimal point
...
//This function updates the calculator screen with the contesnts of Display_Value
...
keys.addEventListener('click', (event) => {
    ...
    //that was clicked
    const {target} = event;
    //If the element that was clicked on is not a button, exit the fucntion
