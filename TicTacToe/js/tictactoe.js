...
function placeXOrO(squareNumber) {
    ...
    if(!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This calls a fuction to check for any win conditions.
        checkWinConditions();
...
//This function results in a random square being selected by the compuyter.
...
function audio(audioURL) {
    ...
    //Play method plays our audtio sound
    audio.play();
}
...
function resetGame(){
    ...
    for (let i = 0; i < 9; i++){
        ...
        //This removes our elements backgroundImgae
